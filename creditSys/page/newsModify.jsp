...
<body style="padding: 5px 10px">
	...
	<div class="panel panel-primary">
	  ...
	  <div class="panel-body">
	  		<form class="form-horizontal" role="form" action="newsModify.do" method="post" onsubmit="return result()" enctype="multipart/form-data">
            <div class="form-group">
              <label for="newsId" class="col-lg-2 control-label">新闻编号</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" id="newsId" name="newsId" value="${news.id}"  readonly="readonly"/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" class="form-control" id="newsName" name="newsName" placeholder="${news.title}" onblur="checkTitle()">
			...
			<div class="btn-toolbar" data-role="editor-toolbar"	data-target="#content">
             ...
             <div id="content" style="overflow:scroll; max-height:300px;border: 1px solid;height: 1400px;">
             	<textarea rows="100px" cols="200px" name="newsContent">${news.context }</textarea>
             </div>
         </div>
     </div>
            <div class="form-group">
                        ...
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <div class="input-group">
                                 <div class="fileupload-new thumbnail" style="width: 130px; height: 139px;">
                                     <img src="/resource/${news.newFileName}"  alt=""/>
                                 </div>
