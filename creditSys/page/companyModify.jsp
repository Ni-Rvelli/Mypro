...
<body style="padding: 5px 10px">
	...
	<div class="panel panel-primary">
	  ...
	  <div class="panel-body">
	  		...
	  		<form class="form-horizontal" id="message" role="form" action="companyModify.do" method="post">
	  		
	  		<div class="form-group">
              <label for="companyId" class="col-lg-2 control-label">企业编号</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" id="companyId" name="companyId" value="${company.id }" readonly="readonly">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" class="form-control" id="companyName" name="companyName" placeholder="产品名称" value="${company.companyName }">
              </div>
            </div>
            ...
            <div class="form-group">
            	...
            	<div class="col-lg-10">
			        <div class="input-group col-lg-3" style="float: left;">
			            <input type="text" class="form-control" placeholder="佣金数" name="percentage" value="${company.percentage }">
...
<!--               	asdalksdjklasj -->
            ...
            <div id="content" style="overflow:scroll; max-height:300px;border: 1px solid;height: 200px;">${company.context }</div>
         </div>
     </div>
            ...
            <div class="form-group">
              <div class="col-lg-offset-2 col-lg-10">
                <button type="button" onclick="sub()" class="btn btn-lg btn-info" style="padding: 15px 60px;border-radius: 0px;">修改</button>
              </div>
            </div>
          </form>
