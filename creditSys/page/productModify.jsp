...
<body style="padding: 5px 10px">
	...
	<div class="panel panel-primary">
	  ...
	  <div class="panel-body">
	  		...
	  		<form class="form-horizontal" role="form" action="productUp.do" onSubmit="subCont()" enctype="multipart/form-data" method="post">
	  		
	  		<div class="form-group">
              <label for="productID" class="col-lg-2 control-label">产品编号</label>
              <div class="col-lg-10">
                <input type="text" class="form-control" name="productNo" id="productID" value="${productNo}" readonly="readonly">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" class="form-control" name="productName" id="productName" placeholder="产品名称">
              </div>
            </div>
